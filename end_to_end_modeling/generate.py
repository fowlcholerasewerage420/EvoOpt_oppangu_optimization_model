...
def parse_args():
    ...
    parser.add_argument("--dataset_name", type=str, required=True, help="数据集路径")
    parser.add_argument("--dataset_split", type=str, default="train", help="数据集划分")
    parser.add_argument("--save_dir", type=str, required=True, help="输出目录")
    parser.add_argument("--tensor_parallel_size", type=int, default=4, help="张量并行大小（GPU数量）")
    parser.add_argument("--topk", type=int, default=1, help="生成的候选数量")
    ...
    parser.add_argument("--decoding_method", type=str, default="greedy", help="解码方法：greedy或sampling")
